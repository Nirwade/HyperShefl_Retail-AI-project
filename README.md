...
```
This copies 500-row sample CSVs to the correct paths so the dashboard boots immediately with real-looking data. For the full 3.7GB dataset see [Full Dataset](https://drive.google.com/drive/folders/1jFjS_lV4rXaEa_0GM0_-35NLjfJOzDOr?usp=sharing....c/ss)
